package com.cqut.housingrental.controller.landlord;
...
import com.cqut.housingrental.entity.landlord.Landlord;
...
public class landlordController{
	...
	@ResponseBody
	public JSONObject getWithPaging(String searchText,HttpServletRequest request) {
		Map<String,Object> result=new HashMap<String, Object>();
		
			result=publicService.getWithPaging(30, 0, null, null, searchText,"landlord","id");
	...
	@ResponseBody
	public JSONObject update(Landlord entity) {
	...
	@RequestMapping("/save")
	@ResponseBody
	public JSONObject save(Landlord entity) {	
	...
	public JSONObject delete(String ids) {
		...
		int result=0;
		try{
			result=publicService.delete(idStrings,Landlord.class);
			returnObj.put("result",result);
		}
